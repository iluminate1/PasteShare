...
from pasteshare.api.v1.comment import router as comment_router
from pasteshare.api.v1.language import router as language_router
from pasteshare.api.v1.paste import router as paste_router
...
api_v1.include_router(comment_router, prefix="/paste/comment", tags=["Comment"])
api_v1.include_router(paste_router, prefix="/paste", tags=["Paste"])
